											...
											foreach( $EM_Tickets->tickets as $EM_Ticket){
												...
												<tr valign="top" id="em-tickets-row-<?php echo $col_count ?>" class="em-tickets-row">
													...
													<td class="ticket-actions">
														...
														<input type="hidden" class="ticket_name" name="em_tickets[<?php echo $col_count; ?>][ticket_name]" value="<?php echo esc_attr(stripslashes($EM_Ticket->name)) ?>" />
														<input type="hidden" class="ticket_description" name="em_tickets[<?php echo $col_count; ?>][ticket_description]" value="<?php echo esc_attr(stripslashes($EM_Ticket->description)) ?>" />
