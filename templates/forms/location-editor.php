<?php
	...
	<form enctype='multipart/form-data' id='location-form' method='post' action=''>
		...
		<input type='hidden' id='location-latitude' name='location_latitude' value='<?php echo $EM_Location->location_latitude; ?>' size='15' />
		<input type='hidden' id='location-longitude' name='location_longitude' value='<?php echo $EM_Location->location_longitude; ?>' size='15' />
