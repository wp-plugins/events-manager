...
<div class="em-events-search">
	...
	<form action="" method="post" class="em-events-search-form">
		...
		<select name="state">
			...
			global $wpdb;
			$states = $wpdb->get_results("SELECT DISTINCT location_state FROM ".$wpdb->prefix.EM_LOCATIONS_TABLE." WHERE location_state IS NOT NULL ORDER BY location_state ASC", ARRAY_N);
