		  	...
		  	<div class="em-menu-formats em-menu-group" style="display:none;">				
				...
				<div class="inside">
	            	<table class="form-table">
						...
						em_options_input_text ( __( 'Date Seperator', 'dbem' ), 'dbem_times_seperator', sprintf(__( 'For when start/end %s are present, this will seperate the two (include spaces here if necessary).', 'dbem' ), __('times','dbem')) );
						echo $save_button;
						?>
					</table>
				</div> <!-- . inside -->
