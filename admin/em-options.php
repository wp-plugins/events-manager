...
add_action('network_admin_head', 'em_options_save');
			...
			<!-- PAGE OPTIONS -->
		  	<div class="em-menu-pages em-menu-group" style="display:none;">			
				...
				<div class="inside">
	            	...
	            	em_options_select ( sprintf(__( '%s page', 'dbem' ),__('Categories','dbem')), 'dbem_categories_page', $events_page_options, sprintf(__( 'This option allows you to select which page to use as the %s page. If you do not select no %s page, to display lists you can enable archives or use the appropriate shortcodes and/or template tags.','dbem' ),__('categories','dbem'),__('categories','dbem')) );
					?>
	            	...
	            	em_options_radio_binary ( __( 'Include in WordPress Searches?', 'dbem' ), 'dbem_cp_categories_search_results', sprintf(__( "Allow %s to appear in the built-in search results.", 'dbem' ),__('categories','dbem')) );
					?>
					<tr valign="top">
				   		<th scope="row"><?php _e('Default archive ordering','dbem'); ?></th>
				   		<td>   
		  	...
		  	<div class="em-menu-formats em-menu-group" style="display:none;">				
				...
				<div class="inside">
	            	<table class="form-table">
						...
						<?php
						em_options_input_text ( sprintf(__('%s page title','dbem'),__('Locations','dbem')), 'dbemcategoryns_page_title', sprintf(__( 'The title on the multiple %s page.', 'dbem' ), __('locations','dbem')) );
