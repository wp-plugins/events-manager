	...
	<div class="wrap">
		...
		<form id="dbem_options_form" method="post" action="">          
			...
			<div class="inside">
				<table class='form-table'>
					<?php
					dbem_options_select ( __( 'Default contact person', 'dbem' ), 'dbem_default_contact_person', dbem_get_wp_users (), __( 'Select the default contact person. This user will be employed whenever a contact person is not explicitly specified for an event', 'dbem' ) );
